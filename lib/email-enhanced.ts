    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p><strong style="font-family: 'Cookie', cursive; font-size: 2em; letter-spacing: 0.01em;">${companyData.name || 'SmartInvoice'}</strong></p>
  ...
  static generateReminderEmail(invoiceData: Invoice, companyData: CompanyData, daysOverdue: number): string {
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1 style="font-family: 'Cookie', cursive; font-size: 2.5em; letter-spacing: 0.01em;">Payment Reminder</h1>
      ...
      <body>
        <div class="container">
          ...
          <div class="body">
            ...
            <div class="signature">
              Warm regards,<br />
              <strong style="font-family: 'Cookie', cursive; font-size: 2em; letter-spacing: 0.01em;">Harsh Bhardwaj</strong><br />
